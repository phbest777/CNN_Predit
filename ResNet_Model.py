...
if __name__=='__main__':
    data_dir = 'D:\PythonProject\AI\PyTorch\CNN_Predit\DATA\IMG\Flower'
    ...
    model = train_model(model_ft, data_loaders['train'], data_loaders['valid'], optimizer_ft, criterion, 30, filename)